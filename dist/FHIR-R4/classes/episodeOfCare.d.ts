 ...
 */
export declare class EpisodeOfCare {
    /**
     ...
     */
    status?: EpisodeOfCare.StatusEnum;
    /**
...
export declare namespace EpisodeOfCare {
    type StatusEnum = 'planned' | 'waitlist' | 'active' | 'onhold' | 'finished' | 'cancelled' | 'entered-in-error';
    const StatusEnum: {
        Planned: StatusEnum;
        Waitlist: StatusEnum;
        Active: StatusEnum;
