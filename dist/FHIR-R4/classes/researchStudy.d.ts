...
export declare class ResearchStudy {
     ...
     */
    status?: ResearchStudy.StatusEnum;
    /**
...
export declare namespace ResearchStudy {
    type StatusEnum = 'active' | 'administratively-completed' | 'approved' | 'closed-to-accrual' | 'closed-to-accrual-and-intervention' | 'completed' | 'disapproved' | 'in-review' | 'temporarily-closed-to-accrual' | 'temporarily-closed-to-accrual-and-intervention' | 'withdrawn';
    const StatusEnum: {
        Active: StatusEnum;
        AdministrativelyCompleted: StatusEnum;
        Approved: StatusEnum;
        ClosedToAccrual: StatusEnum;
        ClosedToAccrualAndIntervention: StatusEnum;
        Completed: StatusEnum;
        Disapproved: StatusEnum;
        InReview: StatusEnum;
        TemporarilyClosedToAccrual: StatusEnum;
        TemporarilyClosedToAccrualAndIntervention: StatusEnum;
        Withdrawn: StatusEnum;
    };
}
