...
export declare namespace DiagnosticReport {
    type StatusEnum = 'registered' | 'partial' | 'preliminary' | 'final' | 'amended' | 'corrected' | 'appended' | 'cancelled' | 'entered-in-error' | 'unknown';
    const StatusEnum: {
        Registered: StatusEnum;
        Partial: StatusEnum;
        Preliminary: StatusEnum;
        Final: StatusEnum;
        Amended: StatusEnum;
        Corrected: StatusEnum;
        Appended: StatusEnum;
