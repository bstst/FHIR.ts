 ...
 */
export declare class SupplyDelivery {
    /**
...
export declare namespace SupplyDelivery {
    type StatusEnum = 'in-progress' | 'completed' | 'abandoned' | 'entered-in-error';
    const StatusEnum: {
        InProgress: StatusEnum;
        Completed: StatusEnum;
        Abandoned: StatusEnum;
