 ...
 */
export declare class DeviceUseStatement {
    /**
...
export declare namespace DeviceUseStatement {
    type StatusEnum = 'active' | 'completed' | 'entered-in-error' | 'intended' | 'stopped' | 'on-hold';
    const StatusEnum: {
        Active: StatusEnum;
