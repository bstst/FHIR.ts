...
export declare namespace Bundle {
    type TypeEnum = 'document' | 'message' | 'transaction' | 'transaction-response' | 'batch' | 'batch-response' | 'history' | 'searchset' | 'collection';
    const TypeEnum: {
        Document: TypeEnum;
        Message: TypeEnum;
        Transaction: TypeEnum;
        TransactionResponse: TypeEnum;
        Batch: TypeEnum;
        BatchResponse: TypeEnum;
        History: TypeEnum;
        Searchset: TypeEnum;
        Collection: TypeEnum;
    };
