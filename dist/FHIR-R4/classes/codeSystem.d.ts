...
export declare namespace CodeSystem {
    ...
    type HierarchyMeaningEnum = 'grouped-by' | 'is-a' | 'part-of' | 'classified-with';
    const HierarchyMeaningEnum: {
        GroupedBy: HierarchyMeaningEnum;
        IsA: HierarchyMeaningEnum;
        PartOf: HierarchyMeaningEnum;
        ClassifiedWith: HierarchyMeaningEnum;
    };
    type ContentEnum = 'not-present' | 'example' | 'fragment' | 'complete' | 'supplement';
    const ContentEnum: {
        NotPresent: ContentEnum;
        Example: ContentEnum;
        Fragment: ContentEnum;
        Complete: ContentEnum;
        Supplement: ContentEnum;
    };
}
