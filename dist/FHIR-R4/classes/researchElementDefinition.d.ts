 ...
 */
export declare class ResearchElementDefinition {
    /**
...
export declare namespace ResearchElementDefinition {
    ...
    type TypeEnum = 'population' | 'exposure' | 'outcome';
    const TypeEnum: {
        Population: TypeEnum;
        Exposure: TypeEnum;
        Outcome: TypeEnum;
    };
    type VariableTypeEnum = 'dichotomous' | 'continuous' | 'descriptive';
    const VariableTypeEnum: {
        Dichotomous: VariableTypeEnum;
        Continuous: VariableTypeEnum;
        Descriptive: VariableTypeEnum;
    };
}
