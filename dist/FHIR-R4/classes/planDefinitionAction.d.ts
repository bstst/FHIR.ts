 ...
 */
export declare class PlanDefinitionAction {
    /**
...
export declare namespace PlanDefinitionAction {
    type GroupingBehaviorEnum = 'visual-group' | 'logical-group' | 'sentence-group';
    const GroupingBehaviorEnum: {
        VisualGroup: GroupingBehaviorEnum;
        LogicalGroup: GroupingBehaviorEnum;
        SentenceGroup: GroupingBehaviorEnum;
    };
    type SelectionBehaviorEnum = 'any' | 'all' | 'all-or-none' | 'exactly-one' | 'at-most-one' | 'one-or-more';
    const SelectionBehaviorEnum: {
        Any: SelectionBehaviorEnum;
        All: SelectionBehaviorEnum;
        AllOrNone: SelectionBehaviorEnum;
        ExactlyOne: SelectionBehaviorEnum;
        AtMostOne: SelectionBehaviorEnum;
        OneOrMore: SelectionBehaviorEnum;
    };
    type RequiredBehaviorEnum = 'must' | 'could' | 'must-unless-documented';
    const RequiredBehaviorEnum: {
        Must: RequiredBehaviorEnum;
        Could: RequiredBehaviorEnum;
        MustUnlessDocumented: RequiredBehaviorEnum;
    };
    type PrecheckBehaviorEnum = 'yes' | 'no';
    const PrecheckBehaviorEnum: {
        Yes: PrecheckBehaviorEnum;
        No: PrecheckBehaviorEnum;
    };
    type CardinalityBehaviorEnum = 'single' | 'multiple';
    const CardinalityBehaviorEnum: {
        Single: CardinalityBehaviorEnum;
        Multiple: CardinalityBehaviorEnum;
    };
}
