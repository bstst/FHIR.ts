 ...
 */
export declare class AllergyIntolerance {
    /**
...
export declare namespace AllergyIntolerance {
    type TypeEnum = 'allergy' | 'intolerance';
    const TypeEnum: {
        Allergy: TypeEnum;
        Intolerance: TypeEnum;
    };
    type CriticalityEnum = 'low' | 'high' | 'unable-to-assess';
    const CriticalityEnum: {
        Low: CriticalityEnum;
        High: CriticalityEnum;
        UnableToAssess: CriticalityEnum;
    };
}
