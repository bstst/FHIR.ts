 ...
 */
export declare class BiologicallyDerivedProduct {
    /**
...
export declare namespace BiologicallyDerivedProduct {
    type ProductCategoryEnum = 'organ' | 'tissue' | 'fluid' | 'cells' | 'biologicalAgent';
    const ProductCategoryEnum: {
        Organ: ProductCategoryEnum;
        Tissue: ProductCategoryEnum;
        Fluid: ProductCategoryEnum;
        Cells: ProductCategoryEnum;
        BiologicalAgent: ProductCategoryEnum;
    };
    type StatusEnum = 'available' | 'unavailable';
    const StatusEnum: {
        Available: StatusEnum;
        Unavailable: StatusEnum;
    };
}
