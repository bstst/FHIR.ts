 ...
 */
import { ClaimAccident } from './../classes/claimAccident';
import { ClaimCareTeam } from './../classes/claimCareTeam';
import { ClaimDiagnosis } from './../classes/claimDiagnosis';
import { ClaimInsurance } from './../classes/claimInsurance';
import { ClaimItem } from './../classes/claimItem';
import { ClaimPayee } from './../classes/claimPayee';
import { ClaimProcedure } from './../classes/claimProcedure';
import { ClaimRelated } from './../classes/claimRelated';
import { ClaimSupportingInfo } from './../classes/claimSupportingInfo';
...
export declare namespace Claim {
    type UseEnum = 'claim' | 'preauthorization' | 'predetermination';
    const UseEnum: {
        Claim: UseEnum;
        Preauthorization: UseEnum;
        Predetermination: UseEnum;
    };
}
