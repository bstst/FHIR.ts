...
import { FamilyMemberHistoryCondition } from './../classes/familyMemberHistoryCondition';
...
export declare namespace FamilyMemberHistory {
    type StatusEnum = 'partial' | 'completed' | 'entered-in-error' | 'health-unknown';
    const StatusEnum: {
        Partial: StatusEnum;
        Completed: StatusEnum;
        EnteredInError: StatusEnum;
        HealthUnknown: StatusEnum;
    };
}
