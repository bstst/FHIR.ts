...
import { ChargeItemPerformer } from './../classes/chargeItemPerformer';
...
export declare namespace ChargeItem {
    type StatusEnum = 'planned' | 'billable' | 'not-billable' | 'aborted' | 'billed' | 'entered-in-error' | 'unknown';
    const StatusEnum: {
        Planned: StatusEnum;
        Billable: StatusEnum;
        NotBillable: StatusEnum;
        Aborted: StatusEnum;
        Billed: StatusEnum;
