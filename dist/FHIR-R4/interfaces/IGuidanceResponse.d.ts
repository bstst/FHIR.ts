...
import { DataRequirement } from './../classes/dataRequirement';
...
export declare namespace GuidanceResponse {
    type StatusEnum = 'success' | 'data-requested' | 'data-required' | 'in-progress' | 'failure' | 'entered-in-error';
    const StatusEnum: {
        Success: StatusEnum;
        DataRequested: StatusEnum;
        DataRequired: StatusEnum;
