 ...
 */
import { AppointmentParticipant } from './../classes/appointmentParticipant';
...
export declare namespace Appointment {
    type StatusEnum = 'proposed' | 'pending' | 'booked' | 'arrived' | 'fulfilled' | 'cancelled' | 'noshow' | 'entered-in-error' | 'checked-in' | 'waitlist';
    const StatusEnum: {
        Proposed: StatusEnum;
        Pending: StatusEnum;
        Booked: StatusEnum;
