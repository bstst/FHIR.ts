...
import { SupplyRequestParameter } from './../classes/supplyRequestParameter';
...
export interface ISupplyRequest {
     ...
     */
    status?: SupplyRequest.StatusEnum;
    /**
...
export declare namespace SupplyRequest {
    type StatusEnum = 'draft' | 'active' | 'suspended' | 'cancelled' | 'completed' | 'entered-in-error' | 'unknown';
    const StatusEnum: {
        Draft: StatusEnum;
        Active: StatusEnum;
