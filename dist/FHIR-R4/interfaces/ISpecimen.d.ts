...
import { SpecimenCollection } from './../classes/specimenCollection';
import { SpecimenContainer } from './../classes/specimenContainer';
import { SpecimenProcessing } from './../classes/specimenProcessing';
...
export declare namespace Specimen {
    type StatusEnum = 'available' | 'unavailable' | 'unsatisfactory' | 'entered-in-error';
    const StatusEnum: {
