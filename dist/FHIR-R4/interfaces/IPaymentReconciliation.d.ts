...
import { PaymentReconciliationDetail } from './../classes/paymentReconciliationDetail';
import { PaymentReconciliationProcessNote } from './../classes/paymentReconciliationProcessNote';
...
export interface IPaymentReconciliation {
     ...
     */
    outcome?: PaymentReconciliation.OutcomeEnum;
    /**
...
export declare namespace PaymentReconciliation {
    type OutcomeEnum = 'queued' | 'complete' | 'error' | 'partial';
    const OutcomeEnum: {
        Queued: OutcomeEnum;
        Complete: OutcomeEnum;
        Error: OutcomeEnum;
        Partial: OutcomeEnum;
    };
}
