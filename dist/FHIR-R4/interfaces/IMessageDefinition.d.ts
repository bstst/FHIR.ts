...
export declare namespace MessageDefinition {
    ...
    type CategoryEnum = 'consequence' | 'currency' | 'notification';
    const CategoryEnum: {
        Consequence: CategoryEnum;
        Currency: CategoryEnum;
        Notification: CategoryEnum;
    };
    type ResponseRequiredEnum = 'always' | 'on-error' | 'never' | 'on-success';
    const ResponseRequiredEnum: {
        Always: ResponseRequiredEnum;
        OnError: ResponseRequiredEnum;
        Never: ResponseRequiredEnum;
        OnSuccess: ResponseRequiredEnum;
    };
}
