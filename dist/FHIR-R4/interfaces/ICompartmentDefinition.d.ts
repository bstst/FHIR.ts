...
import { CompartmentDefinitionResource } from './../classes/compartmentDefinitionResource';
...
export interface ICompartmentDefinition {
     ...
     */
    status?: CompartmentDefinition.StatusEnum;
    /**
     ...
     */
    code?: CompartmentDefinition.CodeEnum;
    /**
...
export declare namespace CompartmentDefinition {
    ...
    type CodeEnum = 'Patient' | 'Encounter' | 'RelatedPerson' | 'Practitioner' | 'Device';
    const CodeEnum: {
        Patient: CodeEnum;
        Encounter: CodeEnum;
        RelatedPerson: CodeEnum;
        Practitioner: CodeEnum;
        Device: CodeEnum;
    };
}
