...
import { SearchParameterComponent } from './../classes/searchParameterComponent';
...
export interface ISearchParameter {
     ...
     */
    status?: SearchParameter.StatusEnum;
    /**
     ...
     */
    xpathUsage?: SearchParameter.XpathUsageEnum;
    /**
...
export declare namespace SearchParameter {
    ...
    type TypeEnum = 'number' | 'date' | 'string' | 'token' | 'reference' | 'composite' | 'quantity' | 'uri' | 'special';
    const TypeEnum: {
        Number: TypeEnum;
        Date: TypeEnum;
        String: TypeEnum;
    ...
    type XpathUsageEnum = 'normal' | 'phonetic' | 'nearby' | 'distance' | 'other';
    const XpathUsageEnum: {
        Normal: XpathUsageEnum;
        Phonetic: XpathUsageEnum;
        Nearby: XpathUsageEnum;
        Distance: XpathUsageEnum;
        Other: XpathUsageEnum;
    };
}
