...
import { TaskOutput } from './../classes/taskOutput';
import { TaskRestriction } from './../classes/taskRestriction';
...
export declare namespace Task {
    type StatusEnum = 'draft' | 'requested' | 'received' | 'accepted' | 'rejected' | 'ready' | 'cancelled' | 'in-progress' | 'on-hold' | 'failed' | 'completed' | 'entered-in-error';
    const StatusEnum: {
        Draft: StatusEnum;
        Requested: StatusEnum;
        Received: StatusEnum;
        Accepted: StatusEnum;
        Rejected: StatusEnum;
        Ready: StatusEnum;
    ...
    type IntentEnum = 'unknown' | 'proposal' | 'plan' | 'order' | 'original-order' | 'reflex-order' | 'filler-order' | 'instance-order' | 'option';
    const IntentEnum: {
        Unknown: IntentEnum;
        Proposal: IntentEnum;
        Plan: IntentEnum;
        Order: IntentEnum;
        OriginalOrder: IntentEnum;
        ReflexOrder: IntentEnum;
        FillerOrder: IntentEnum;
        InstanceOrder: IntentEnum;
        Option: IntentEnum;
    };
}
