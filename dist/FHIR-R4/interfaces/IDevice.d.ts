...
import { DeviceDeviceName } from './../classes/deviceDeviceName';
import { DeviceProperty } from './../classes/deviceProperty';
import { DeviceSpecialization } from './../classes/deviceSpecialization';
import { DeviceUdiCarrier } from './../classes/deviceUdiCarrier';
import { DeviceVersion } from './../classes/deviceVersion';
...
export declare namespace Device {
    type StatusEnum = 'active' | 'inactive' | 'entered-in-error' | 'unknown';
    const StatusEnum: {
        Active: StatusEnum;
        Inactive: StatusEnum;
