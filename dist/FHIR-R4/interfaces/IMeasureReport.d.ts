...
import { MeasureReportGroup } from './../classes/measureReportGroup';
...
export declare namespace MeasureReport {
    type StatusEnum = 'complete' | 'pending' | 'error';
    const StatusEnum: {
        Complete: StatusEnum;
        Pending: StatusEnum;
        Error: StatusEnum;
    };
    type TypeEnum = 'individual' | 'subject-list' | 'summary' | 'data-collection';
    const TypeEnum: {
        Individual: TypeEnum;
        SubjectList: TypeEnum;
        Summary: TypeEnum;
        DataCollection: TypeEnum;
    };
}
