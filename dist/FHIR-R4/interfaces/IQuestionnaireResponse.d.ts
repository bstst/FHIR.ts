...
import { QuestionnaireResponseItem } from './../classes/questionnaireResponseItem';
...
export declare namespace QuestionnaireResponse {
    type StatusEnum = 'in-progress' | 'completed' | 'amended' | 'entered-in-error' | 'stopped';
    const StatusEnum: {
