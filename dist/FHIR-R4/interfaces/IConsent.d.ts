...
import { ConsentPolicy } from './../classes/consentPolicy';
import { ConsentProvision } from './../classes/consentProvision';
import { ConsentVerification } from './../classes/consentVerification';
...
export declare namespace Consent {
    type StatusEnum = 'draft' | 'proposed' | 'active' | 'rejected' | 'inactive' | 'entered-in-error';
    const StatusEnum: {
        Draft: StatusEnum;
        Proposed: StatusEnum;
        Active: StatusEnum;
