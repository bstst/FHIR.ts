...
import { StructureDefinitionContext } from './../classes/structureDefinitionContext';
import { StructureDefinitionDifferential } from './../classes/structureDefinitionDifferential';
import { StructureDefinitionMapping } from './../classes/structureDefinitionMapping';
import { StructureDefinitionSnapshot } from './../classes/structureDefinitionSnapshot';
...
export interface IStructureDefinition {
     ...
     */
    status?: StructureDefinition.StatusEnum;
    /**
     ...
     */
    fhirVersion?: StructureDefinition.FhirVersionEnum;
    /**
     ...
     */
    kind?: StructureDefinition.KindEnum;
    /**
     ...
     */
    derivation?: StructureDefinition.DerivationEnum;
    /**
...
export declare namespace StructureDefinition {
    ...
    type FhirVersionEnum = '0.01' | '0.05' | '0.06' | '0.11' | '0.0.80' | '0.0.81' | '0.0.82' | '0.4.0' | '0.5.0' | '1.0.0' | '1.0.1' | '1.0.2' | '1.1.0' | '1.4.0' | '1.6.0' | '1.8.0' | '3.0.0' | '3.0.1' | '3.3.0' | '3.5.0' | '4.0.0';
    const FhirVersionEnum: {
        _001: FhirVersionEnum;
        _005: FhirVersionEnum;
        _006: FhirVersionEnum;
        _011: FhirVersionEnum;
        _0080: FhirVersionEnum;
        _0081: FhirVersionEnum;
        _0082: FhirVersionEnum;
        _040: FhirVersionEnum;
        _050: FhirVersionEnum;
        _100: FhirVersionEnum;
        _101: FhirVersionEnum;
        _102: FhirVersionEnum;
        _110: FhirVersionEnum;
        _140: FhirVersionEnum;
        _160: FhirVersionEnum;
        _180: FhirVersionEnum;
        _300: FhirVersionEnum;
        _301: FhirVersionEnum;
        _330: FhirVersionEnum;
        _350: FhirVersionEnum;
        _400: FhirVersionEnum;
    };
    type KindEnum = 'primitive-type' | 'complex-type' | 'resource' | 'logical';
    const KindEnum: {
        PrimitiveType: KindEnum;
        ComplexType: KindEnum;
        Resource: KindEnum;
        Logical: KindEnum;
    };
    type DerivationEnum = 'specialization' | 'constraint';
    const DerivationEnum: {
        Specialization: DerivationEnum;
        Constraint: DerivationEnum;
    };
}
