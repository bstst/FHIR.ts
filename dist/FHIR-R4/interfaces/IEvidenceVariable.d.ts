...
import { EvidenceVariableCharacteristic } from './../classes/evidenceVariableCharacteristic';
...
export interface IEvidenceVariable {
     ...
     */
    status?: EvidenceVariable.StatusEnum;
    /**
...
export declare namespace EvidenceVariable {
    ...
    type TypeEnum = 'dichotomous' | 'continuous' | 'descriptive';
    const TypeEnum: {
        Dichotomous: TypeEnum;
        Continuous: TypeEnum;
        Descriptive: TypeEnum;
    };
}
