...
import { NamingSystemUniqueId } from './../classes/namingSystemUniqueId';
...
export interface INamingSystem {
     ...
     */
    status?: NamingSystem.StatusEnum;
    /**
     * Indicates the purpose for the naming system - what kinds of things does it make unique?
     */
    kind?: NamingSystem.KindEnum;
    /**
...
export declare namespace NamingSystem {
    ...
    type KindEnum = 'codesystem' | 'identifier' | 'root';
    const KindEnum: {
        Codesystem: KindEnum;
        Identifier: KindEnum;
        Root: KindEnum;
